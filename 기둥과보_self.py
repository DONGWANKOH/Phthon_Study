# bar = [[]]
# beam = [[]]
#설치만 하는 경우 삭제만 하는 경우 나눠서
#분기, 삭제 정의가 어렵다.. 구현에 대한 부분을 연습하기 위해서 진행
#기둥,보 설치 조건이 2가지로 구현된다.
# 기둥 설치 조건 >>4가지다/
# 보 설치 조건 >> 3가지 case
#헤매는 경우에는 변수명을 직관적으로 설정할 수 있어야 한다.
#코드 단에서 주석으로 표기한다.
#이게 정말 가능한지 check하는 것. >유지보수, 코드 수정 에 따라 기능을 나눠서 작성해야한다.
#설치는 무조건 일어난다.
